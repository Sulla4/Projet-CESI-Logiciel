  ...
  <div>
    <div ref="sideNav" class="bm-menu">
      <nav class="bm-item-list">
        ...
        <button @click="darkThemeSwitch" id="themeButton"><i class="far fa-moon"></i><i class="fas fa-sun"></i></button>

        <a href="Documentation_API.pdf" target="_blank"><p>Download API Doc</p></a>
      </nav>
...
export default {
  ...
  data() {
    return {
      isSideBarOpen: false,
      isLogged : localStorage.getItem('user') === '' ? 'profile' : 'login',
    };
  },
  props: {
    isOpen: {
